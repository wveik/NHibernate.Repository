...
{
    public class pGetVisaTouristListMap : ClassMap<pGetVisaTouristList>
    {
        public pGetVisaTouristListMap()
        {
            Id(x => x.VTL_KEY);
            Map(x => x.VTL_NAME);
            Map(x => x.VTL_COUNTRY_KEY);
            Map(x => x.VTL_PARTNER_KEY);
            ...
            Map(x => x.VTL_FIRST_TOUR_START_STRING);
            Map(x => x.VTL_LAST_TOUR_START_STRING);
            Map(x => x.VTL_COMMENT);
            ...
            Map(x => x.PREFERABLE_PAYMENT_WAY);
        }
    }
}
